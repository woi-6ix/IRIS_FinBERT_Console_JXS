...
with st.sidebar.form("analysis_form"):
    ...
    ticker = st.text_input("Stock Ticker", "SQ").strip().upper()
...
if not run_button:
    st.info("Enter a ticker and click **Run Analysis** to start. Using the button prevents repeated Yahoo Finance calls and helps avoid rate limits.")
    st.stop()
