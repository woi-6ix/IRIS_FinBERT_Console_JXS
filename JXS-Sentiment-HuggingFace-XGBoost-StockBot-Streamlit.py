...
if not run_button:
    st.info("In open sidebar in top left corner, enter a ticker and click **Run Analysis** to start. Using the button prevents repeated Yahoo Finance calls and helps avoid rate limits.")
    st.stop()
